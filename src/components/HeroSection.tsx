...
import { Play, Users, Sparkles, Trophy, Flame, Zap, Shield, Gift, Swords } from 'lucide-react';
...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-[#00F0FF]/25 bg-gradient-to-b from-[#0d121c] via-[#080b10] to-[#05070a] p-6 lg:p-12 shadow-2xl">
      {/* Ambient Neon Glows */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-[#00F0FF]/40 text-xs font-mono backdrop-blur-md">
            ...
            <span className="text-[#00F0FF] font-bold">3,140 SQUAD PLAYERS CHILLING NOW</span>
            <span className="text-gray-600">|</span>
            <span className="text-gray-300">INDIA SQUAD SERVERS 🇮🇳</span>
          </div>

          {/* Main Cinematic Esports Headline */}
          <div className="space-y-2">
            ...
            <p className="text-sm sm:text-base text-gray-300 font-sans max-w-xl leading-relaxed pt-2">
              The premier Indian multiplayer browser arcade. Jump into instant 30-sec duels with your hostel gang & college friends. Flip Reynolds pens, smash gully cricket sixes, brew chai, and roast your rivals with zero app downloads.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            >
              ...
              <span>SQUAD ROOM / INVITE CODE</span>
            </button>
          ...
          <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-800/80 font-mono text-[11px] text-gray-400">
            ...
            <div>
              <span className="text-base font-bold text-[#ADFF2F] block font-display">1v1 Room Codes</span>
              <span>Pass & Play / Online</span>
            </div>
            <div>
              <span className="text-base font-bold text-pink-400 block font-display">XP & Coins</span>
              <span>Unlock skins & badges</span>
            </div>
          </div>
        </div>

        {/* Right Column: Interactive Featured Game Hero Card */}
          ...
          <div className="relative rounded-3xl overflow-hidden glass-panel border-[#00F0FF]/30 p-5 bg-[#0a0d14]/90 space-y-4">
            <div className="flex justify-between items-center text-xs font-mono">
              <span className="text-[#00F0FF] font-bold flex items-center gap-1.5">
                <Flame className="w-4 h-4 text-pink-500" /> FEATURED DUEL ARENA
              </span>
            ...
            <div className="relative aspect-[16/10] rounded-2xl overflow-hidden bg-slate-950 border border-gray-800 group-hover:scale-[1.02] transition-transform duration-500 shadow-2xl">
              <img
            ...
            <div className="grid grid-cols-2 gap-2 text-[10px] font-mono">
              ...
              <div className="p-2.5 rounded-xl bg-slate-900/60 border border-gray-800">
                <span className="text-gray-500 block">ACTIVE GAMERS</span>
                <span className="text-[#00F0FF] font-bold">{(featuredGame.playCount / 1000).toFixed(0)}k plays</span>
              </div>
            </div>
            ...
            <Link
              href={`/game/${featuredGame.id}`}
              onClick={() => soundFx.playClick()}
              className="w-full py-3 rounded-xl bg-slate-900 hover:bg-[#00F0FF] text-white hover:text-slate-950 border border-[#00F0FF]/40 text-xs font-black font-display tracking-wider flex items-center justify-center gap-2 transition-all shadow-lg"
            >
