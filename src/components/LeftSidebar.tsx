          ...
          <div className="space-y-1 pt-2 border-t border-[#1A2238]">
            {!isActualCollapsed ? (
              <button
                ...
                className="w-full flex items-center justify-between text-[10px] font-mono font-bold text-gray-500 px-3 uppercase tracking-wider hover:text-white"
              >
                <span>GAME HUBS</span>
            ...
            {(!isActualCollapsed ? categoriesOpen : true) && (
              <div className="space-y-1">
